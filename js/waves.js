/* ================================================
   Waves background (vanilla port of react-bits Waves)
   Auto-injects a fixed full-viewport canvas behind content.
   ================================================ */
(function () {
  'use strict';
  ...
  container.id = 'waves-bg';
  container.className = 'waves-bg';
